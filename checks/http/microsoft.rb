        ...
        def generate_checks(url)
          [
            ...
            },
            {
              ...
              :tags => ["Web Farmework"],
              :vendor => "Microsoft",
              :product => "Remote Desktop Web Access",
              :match_details => "RD Web Access Cookie",
              :version => nil,
              :match_type => :content_headers,
              :match_content => /^set-cookie: TSWAFeatureCheckCookie=true/i,
              :paths => [{ :path => "#{url}", :follow_redirects => true }],
              :inference => true,
            },
            {
              ...
              :vendor => "Microsoft",
              :product => "Remote Desktop Web Access",
              :match_details => "RD Web Access JS Error",
              :version => nil,
              :match_type => :content_body,
              :match_content => /Error: Unable to display RD Web Access/i,
              :paths => [{ :path => "#{url}", :follow_redirects => true }],
              :inference => false,
            },
            {
              ...
              :vendor => "Microsoft",
              :product => "Remote Desktop Web Access",
              :match_details => "RD Web Access Title",
              :version => nil,
              :match_type => :content_title,
              :match_content => /RD Web Access/i,
              :paths => [{ :path => "#{url}", :follow_redirects => true }],
              :inference => false,
            },
            {
